                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card bg-secondary">
                                        <h2 class="card-header text-white">v 2.7.1</h2>
                                        <div class="card-body">
                    ...
                    <div class="modal-body" style="background-color: #2b6670;">
                        <div class="container-fluid">
                            <div class="row mt-3">
                                <div class="col-12 mt-3">
                                    <div class="card">
                                        <h2 class="card-header text-white" style="background-color: #09701a;">Version 2.7.1 has been released! <a class="link-warning" target="_blank" href="https://github.com/Lufion1420/Warcraft-3-Reforged-UI-Designer/releases/latest">Download Now</a></h2>
